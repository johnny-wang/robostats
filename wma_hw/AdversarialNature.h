...
class AdversarialNature : public Nature {
    public:
        ...
        int get_label(int round, std::vector<int> e_pred, std::vector<double> wts);
    ...
    private:
        ...
        void get_true_label(std::map<int, double> wt_sum);
        void print_wt_sum(std::map<int, double> wt_sum);
};
